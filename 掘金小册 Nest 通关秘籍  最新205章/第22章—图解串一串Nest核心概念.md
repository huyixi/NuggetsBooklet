...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/第22章-1.png)

token 可以是 class 也可以是 string：

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/第22章-2.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/第22章-3.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/第22章-4.png)

在 main.ts 里调用 NestFactory.create 方法，就会从 AppModule 开始递归解析 Module，实例化其中的 provider、controller，并依次调用它们的 onModuleInit 生命周期方法。

![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/第22章-5.png)
...
![](//liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/第22章-6.png)
